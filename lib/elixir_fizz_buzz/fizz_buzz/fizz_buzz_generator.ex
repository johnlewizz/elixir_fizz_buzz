defmodule FizzBuzz.FizzBuzzGenerator do
  ...
  def fizz_buzz_check(number) when rem(number, 3) == 0 and rem(number, 5) == 0 do
    %{id: number, value: "fizzbuzz"}
  end

  def fizz_buzz_check(number) when rem(number, 3) == 0 do
    %{id: number, value: "fizz"}
  end

  def fizz_buzz_check(number) when rem(number, 5) == 0 do
    %{id: number, value: "buzz"}
  end

  def fizz_buzz_check(number) do
